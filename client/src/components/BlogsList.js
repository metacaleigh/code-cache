    ...
    {/* <Switch>
        ...
        <div class="container px-5 py-20 mx-auto">
          <div class="text-center -mb-20">
            ...
            <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
              Welcome to the Code/Cache blog! Here you can find the articles about the latest trends in tech and discover the top online resources used by developers worldwide.
            </p>
      ...
      <section class="text-gray-500 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="-my-8 divide-y-2 divide-gray-900">{blogItems}</div>
        </div>
      </section>
    </>
  );
...

{
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="text-center mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Blog</h1>
